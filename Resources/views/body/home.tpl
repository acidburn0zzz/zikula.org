...
<div class="jumbotron">
    <div class="container">
        ...
        <p><a class="btn btn-primary btn-lg" role="button" href="http://go.zikula.org/download_latest"><i class="fa fa-cloud-download fa-3x pull-left"></i> Download Zikula<br />1.3.6</a></p>
    </div>
</div>
...
{pageaddvar name='javascript' value=$themeBundle->getRelativePath()|cat:'/Resources/public/js/modern-business.js'}